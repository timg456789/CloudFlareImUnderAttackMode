...
{
    class CloudFlareImUnderAttackModeHtmlToClearanceRequestTests
    {
...
<html lang=""en-US"">
  ...
  (function(){
                ...
                b(function(){
                    ...
                    setTimeout(function(){
                        var s,t,o,p,b,r,e,a,k,i,n,g,f, NpWhweA={""N"":+((!+[]+!![]+!![]+[])+(+!![]))};
                        ...
                        ;NpWhweA.N-=+((!+[]+!![]+!![]+[])+(!+[]+!![]+!![]+!![]+!![]+!![]+!![]+!![]+!![]));NpWhweA.N-=+((!+[]+!![]+!![]+[])+(+!![]));NpWhweA.N*=+((!+[]+!![]+[])+(+[]));NpWhweA.N-=+((+!![]+[])+(!+[]+!![]+!![]+!![]+!![]));NpWhweA.N-=+((+!![]+[])+(!+[]+!![]+!![]));NpWhweA.N-=+((!+[]+!![]+!![]+!![]+[])+(+[]));NpWhweA.N-=+((!+[]+!![]+[])+(!+[]+!![]+!![]+!![]+!![]+!![]+!![]+!![]));a.value = parseInt(NpWhweA.N, 10) + t.length; '; 121'
                        f.submit();
                    }, 4000);
                }, false);
            })();
                ...
                <td align=""center"" valign=""middle"">
                    <div class=""cf-browser-verification cf-im-under-attack"">
                        ...
                        <form id=""challenge-form"" action=""/cdn-cgi/l/chk_jschl"" method=""get"">
                            <input type=""hidden"" name=""jschl_vc"" value=""b31286bcab0fb9b7d5bc3482c9699b80""/>
                            <input type=""hidden"" name=""pass"" value=""1505545382.875-xV2AjG19R7""/>
